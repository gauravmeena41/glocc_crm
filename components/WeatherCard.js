...
const WeatherCard = () => {
  ...
  return (
    <div
      className="shadow-base hover:shadow-medium dark:shadow-none dark:hover:shadow-none dark:bg-card rounded-xl
     transition-all duration-300 ease-in-out min-h-[250px] pb-10 lg:hover:scale-[1.03]
      "
    >
      <div className="">
