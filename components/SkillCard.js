...
const SkillCard = ({ currentUser }) => {
  return (
    <div className="space-y-5">
      <div
        className="shadow-medium dark:shadow-none lg:hover:shadow-medium dark:shadow-none lg:dark:hover:shadow-none px-5 py-5 space-y-8 font-semibold
      w-full h-full bg-[#fff] dark:bg-card rounded-2xl transition-all duration-300 shadow-medium dark:shadow-none"
      >
