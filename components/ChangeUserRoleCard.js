...
import { changeUserrole, userRoles } from "../helper";
import { useRecoilValue } from "recoil";
import { employeesState } from "../atoms/employees";

const ChangeUserRoleCard = () => {
  ...
  return (
    <div className="flex flex-col m-5 py-2 space-y-3 overflow-scroll h-[350px]">
      <select
        ...
        defaultValue=""
        className="w-full outline-none border-2 border-primary-text-light bg-transparent text-base-text-light dark:text-primary-text-dark p-1 font-medium
        text-lg rounded-xl cursor-pointer dark:bg-[#333333] appearance-none"
      >
